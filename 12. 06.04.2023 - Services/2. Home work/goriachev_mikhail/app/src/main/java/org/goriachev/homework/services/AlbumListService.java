...
public class AlbumListService extends Service {

    public static final String SERVICE_NAME = "org.goriachev.homework.services.AlbumListService";
    ...
    private void run() {
        ...
        api.albumsGetAll().enqueue(
                new CustomCallback<>(
                        listResponse -> {
                            var intent = new Intent(AlbumListFragment.BROADCAST_ACTION);
