...
public class ShipEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // инициализация спиннера типов судна
        initializationShipTypesSpinner();

        // инициализация спиннера типов груза судна
        initializationShipCargoTypesSpinner();

        // инициализация контроллов для ввода данных
    ...
    // инициализация спиннера типов судна
    private void initializationShipTypesSpinner() {
    ...
    // инициализация спиннера типов груза судна
    private void initializationShipCargoTypesSpinner() {
