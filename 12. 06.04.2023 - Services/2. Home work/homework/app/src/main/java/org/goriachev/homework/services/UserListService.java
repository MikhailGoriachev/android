...
public class UserListService extends Service {
    ...
    public static final String SERVICE_NAME = "org.goriachev.homework.services.UserListService";
    ...
    private void run() {
        ...
        api.usersGetAll().enqueue(
                new CustomCallback<>(
                        listResponse -> {
                            var intent = new Intent(UserListFragment.BROADCAST_ACTION);
