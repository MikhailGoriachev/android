package org.goriachev.homework.middleware;
...
public class PolyclinicDatabaseHelper extends SQLiteOpenHelper {

    // путь к базе данных
    private final String DB_PATH;

    // название файла базы данных
    private static final String DB_NAME = "polyclinic.db";
    ...
    public PolyclinicDatabaseHelper(Context context) {
