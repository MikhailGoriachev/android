...
import org.goriachev.homework.adapters.webData.CommentAdapter;
...
import org.goriachev.homework.services.CommentListService;
...
public class CommentListFragment extends Fragment implements Serializable {

    public static final String BROADCAST_ACTION = "org.goriachev.homework.CommentListFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        var intent = new Intent(getContext(), CommentListService.class);
    ...
    public void onReceiveHandler(Context context, Intent intent) {
        ...
        if (serviceName.equals(CommentListService.SERVICE_NAME)) {

            if (resultCode == ResultCode.RESULT_OK)
                rcvItems.setAdapter(new CommentAdapter(
                        getContext(),
                        (List<Comment>) intent.getSerializableExtra("items")
                ));
            else
