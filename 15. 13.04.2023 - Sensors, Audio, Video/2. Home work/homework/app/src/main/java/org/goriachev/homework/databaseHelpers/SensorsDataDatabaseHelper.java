...
public class SensorsDataDatabaseHelper extends SQLiteOpenHelper {

    // путь к базе данных
    private final String DB_PATH;

    // название файла базы данных
    private static final String DB_NAME = "sensors_data.db";
    ...
    public SensorsDataDatabaseHelper(Context context) {
