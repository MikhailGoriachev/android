...
public class CommentListService extends Service {
    ...
    public static final String SERVICE_NAME = "org.goriachev.homework.services.CommentListService";
    ...
    private void run() {
        ...
        api.commentsGetAll().enqueue(
                new CustomCallback<>(
                        listResponse -> {
                            var intent = new Intent(CommentListFragment.BROADCAST_ACTION);
