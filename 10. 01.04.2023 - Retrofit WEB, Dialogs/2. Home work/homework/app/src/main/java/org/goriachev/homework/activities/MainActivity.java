...
import org.goriachev.homework.dialogues.albums.AlbumIdDialog;
...
import org.goriachev.homework.fragments.albums.AlbumFragment;
import org.goriachev.homework.fragments.albums.AlbumListFragment;
...
public class MainActivity extends AppCompatActivity implements MainMenuFragment.MainMenuItemSelected {
    ...
    public void onMainMenuItemSelected(int option) {
        switch (option) {
            ...
            case MainMenuFragment.MainMenuOption.LOAD_DATA:
                loadData();
                break;
            case MainMenuFragment.MainMenuOption.ALBUM_LIST:
                showAlbumList();
                break;
    ...
    protected void onRestoreInstanceState(@NonNull Bundle savedInstanceState) {
        ...
        if (currentFragment != null && isHorizontal) {
            getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.fragment_body, currentFragment)
                    .commit();
